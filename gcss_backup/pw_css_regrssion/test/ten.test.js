...
test("browserstack test for homepage on Windows 8.1 1175x2500 Chrome 42", function () {
/*
    ...
    */
    ...
    resize(driver1, "1176x2500");//browser resize

    driver1.get("http://qa2.programmableweb.com/");
    checkLayout(driver1, "spec/main.spec", ["desktopch421175x2500"]);
    driver1.quit();
